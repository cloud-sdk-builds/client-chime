...
[`@aws-sdk/client-chime`](https://www.npmjs.com/package/@aws-sdk/client-chime/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vdh0/g/QaqAmsboh3vF3TWOlv+XrcJiWSM+sAFi1M/6tZcCwQSCb/xhr3kLQD5iQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-chime": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-chime@3.413.0/index.min.mjs": "sha384-vdh0/g/QaqAmsboh3vF3TWOlv+XrcJiWSM+sAFi1M/6tZcCwQSCb/xhr3kLQD5iQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-chime/blob/refs/tags/3.413.0/LICENSE
```
